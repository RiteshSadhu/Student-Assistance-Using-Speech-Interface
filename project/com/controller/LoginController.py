...
def adminLoadDashboard():
    try:
        if adminLoginSession() == 'admin':
            ...
            activeStudentCount = studentDAO.activeStudentCount()
            activeFacultyCount = loginDAO.activeFacultyCount()
            totalTestCount = testDAO.totalTestCount()
            totalCompeleteTest = testDAO.totalCompletedTestCount()
            totalResutlCount = testDAO.totalResultCount()
            totalTopicCount = topicDAO.totalTopicCount()
            totalQuestionCount = questionDAO.totalQuestionCount()
            return render_template('admin/index.html',
                                   activeStudentCount=activeStudentCount,
                                   activeFacultyCount=activeFacultyCount,
                                   totalTestCount = totalTestCount,
                                   totalCompeleteTest = totalCompeleteTest,
                                   totalResutlCount = totalResutlCount,
